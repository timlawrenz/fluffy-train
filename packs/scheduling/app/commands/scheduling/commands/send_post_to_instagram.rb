...
module Scheduling
  module Commands
    class SendPostToInstagram < GLCommand::Callable
      ...
      def rollback
        # The Instagram Graph API does not support deleting posts.
        # If the container was created but not published, we could potentially delete the container,
        # but there is no rollback for a published post.
