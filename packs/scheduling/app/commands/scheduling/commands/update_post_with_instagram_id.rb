  ...
  module Commands
    class UpdatePostWithInstagramId < GLCommand::Callable
      ...
      def call
        ...
        @original_external_post_id = post.external_post_id

        # Update the post with the instagram_post_id and transition to scheduled
        post.update!(external_post_id: instagram_post_id)
      ...
      def rollback
        ...
        # Revert the status and clear the external_post_id
        post.update!(
          status: @original_status,
          external_post_id: @original_external_post_id
        )
      end
    end
  end
